...
REPORT ZEDR25_PRACTICE007 MESSAGE-ID ZMED25.



" PRACTICE006# ## ### ###

" ## INTO ## ASSIGNING <fs_xxx># ###, MODIFY ###
...
           C_BONUS  TYPE P DECIMALS 2 VALUE '50000.00'.  " 5## ### (CURR ## ##)
...
FIELD-SYMBOLS: <fs_info> LIKE LINE OF GT_INFO,

               <fs_pay_info> LIKE LINE OF GT_PAY_INFO.
...
    PERFORM MAP_COMMON CHANGING <fs_info>-ZDEPCODE <fs_info>-ZDEPCODE_NAME

                                <fs_info>-ZDEPRANK <fs_info>-ZDEPRANK_NAME

                                <fs_info>-ZBANKCODE <fs_info>-ZBANKCODE_NAME.

    IF <fs_info>-ZQFLAG = C_X.
...
    IF <fs_info>-ZGENDER = 'M'.

      <fs_info>-ZGENDER_NAME = '##'.

    ELSEIF <fs_info>-ZGENDER = 'F'.
...
  LOOP AT GT_PAY_INFO ASSIGNING <fs_pay_info>.

    IF <fs_pay_info>-ZQFLAG = C_X.

      IF <fs_pay_info>-ZQDATE+0(6) <= LV_DATE2.
...
    <fs_pay_info>-ZPAY_MONTH = <fs_pay_info>-ZSALARY / 12.

    IF <fs_pay_info>-ZRANK = 'A'.

      <fs_pay_info>-ZPAY_MONTH = <fs_pay_info>-ZPAY_MONTH + C_BONUS.

    ENDIF.



    CHECK <fs_pay_info>-ZPAY_MONTH NE 0.
...
                    CHANGING <fs_pay_info>-ZPAY_MONTH.



    PERFORM MAP_COMMON CHANGING <fs_pay_info>-ZDEPCODE <fs_pay_info>-ZDEPCODE_NAME

                                <fs_pay_info>-ZDEPRANK <fs_pay_info>-ZDEPRANK_NAME

                                <fs_pay_info>-ZBANKCODE <fs_pay_info>-ZBANKCODE_NAME.



    IF <fs_pay_info>-ZPAY_MONTH = 0.
