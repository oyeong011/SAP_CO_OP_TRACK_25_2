...
  FLAG_OFF  TYPE CHAR1 VALUE ' ',   " ###/False (####!)
...
         R_ZG FOR ZEDT21_101-ZFLAG21.    " FLAG (##/## ##)
...
  ZORDNO21    LIKE ZEDT21_100-ZORDNO,

  ZIDCODE21   LIKE ZEDT21_100-ZIDCODE,

  ZMATNR21    LIKE ZEDT21_100-ZMATNR,

  ZMTART21    LIKE ZEDT21_100-ZMTART,

  ZMATNAME21  LIKE ZEDT21_100-ZMATNAME,

  ZVOLUM21    LIKE ZEDT21_100-ZVOLUM,

  VRKME       LIKE ZEDT21_100-VRKME,

  ZNSAMT21    LIKE ZEDT21_100-ZNSAMT,

  ZSLAMT21    LIKE ZEDT21_100-ZSLAMT,

  ZDCAMT21    LIKE ZEDT21_100-ZDCAMT,

  ZSALE_FG_21 LIKE ZEDT21_100-ZSALE_FG,

  ZRET_FG21   LIKE ZEDT21_100-ZRET_FG,

  ZJDATE21    LIKE ZEDT21_100-ZJDATE,

  ZRDATE21    LIKE ZEDT21_100-ZRDATE,
...
  IF    SY-DATUM+4(2) = DAY_01 OR SY-DATUM+4(2) = DAY_03

     OR SY-DATUM+4(2) = DAY_05 OR SY-DATUM+4(2) = DAY_07

     OR SY-DATUM+4(2) = DAY_08 OR SY-DATUM+4(2) = DAY_10
...
    IF SCREEN-GROUP1 = GROUP_DELIV.   " 'DLV'
...
    ELSEIF SCREEN-GROUP1 = GROUP_ORDER.  " 'ORD'
...
      GS_0100-AMT1 = GS_ORDER-ZNSAMT21 * 100.

      GS_0100-AMT2 = GS_ORDER-ZSLAMT21 * 100.

      GS_0100-AMT3 = GS_ORDER-ZDCAMT21 * 100.



      " #### ##

      IF GS_ORDER-ZRDATE21 IS NOT INITIAL.

        CONCATENATE GS_ORDER-ZRDATE21+0(4) '.'

                    GS_ORDER-ZRDATE21+4(2) '.'

                    GS_ORDER-ZRDATE21+6(2)
...
        WRITE: / '|', GS_0100-ZORDNO21   UNDER '####',

                 '|', GS_0100-ZIDCODE21  UNDER 'ID',

                 '|', GS_0100-ZMATNR21   UNDER '####',

                 '|', GS_0100-ZMATNAME21 UNDER '###',

                 '|', GS_0100-ZMAT_NAME  UNDER '##',

                 '|', GS_0100-ZVOLUM21   UNDER '##',
