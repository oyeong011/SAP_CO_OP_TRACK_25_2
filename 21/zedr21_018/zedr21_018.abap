...
"=======================================INTERNAL TABLE FIELD-SYMBOL# TYPE ANY TABLE# ##============================
...
SELECT * FROM ZEDT21_001 into CORRESPONDING FIELDS OF TABLE GT_STUDENT.
