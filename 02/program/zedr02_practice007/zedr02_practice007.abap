...
REPORT ZEDR02_PRACTICE007 MESSAGE-ID ZMED02. "### ##
...
  FIELD-SYMBOLS: <FS1> LIKE GS_SALARY, "GS_SALARY ### ### ####

                 <FS2> TYPE ANY. "GS_SALARY# ## ZMON ### ### ####
...
    ASSIGN GS_SALARY TO <FS1>. "GS_SALARY# ### ##

    CONCATENATE 'ZMON' P_MONTH INTO ZMON. "ZMON10 ## ## ### ##
