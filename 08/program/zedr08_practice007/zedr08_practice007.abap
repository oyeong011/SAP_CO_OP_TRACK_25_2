...
DATA: GT_ZEDT08_105 TYPE TABLE OF ZEDT08_105.
...
      IF GT_ZEDT08_105[] IS NOT INITIAL.

        MODIFY ZEDT08_105 FROM TABLE GT_ZEDT08_105.
...
    SELECT * FROM ZEDT08_105 INTO CORRESPONDING FIELDS OF TABLE GT_ZEDT08_105

      FOR ALL ENTRIES IN GT_SALARY WHERE ZPERNR = GT_SALARY-ZPERNR AND ZYEAR = P_YEAR.
...
FORM UPDATE_PAY USING PV_YEAR PV_MON P_ZPERNR P_ZPAY CHANGING PV_CHECK.



  FIELD-SYMBOLS: <FS_ZEDT08_105> TYPE ZEDT08_105.



  READ TABLE GT_ZEDT08_105 WITH KEY ZPERNR = P_ZPERNR ZYEAR = PV_YEAR ASSIGNING <FS_ZEDT08_105>.
...
    ASSIGN COMPONENT FMON OF STRUCTURE <FS_ZEDT08_105> TO FIELD-SYMBOL(<FS>).
...
      FOR ALL ENTRIES IN GT_ASSESS WHERE ZPERNR = GT_ASSESS-ZPERNR AND ZYEAR = P_YEAR.
...
FORM GET_PAY USING PV_YEAR PV_MON P_ZPERNR CHANGING P_ZMON.
...
  READ TABLE GT_ZEDT08_105 WITH KEY ZPERNR = P_ZPERNR

                                    ZYEAR = P_YEAR ASSIGNING <FS_ZEDT08_105>.
