...
*&  Include           ZEDR12_ZCLASSEVENT_F01

*&---------------------------------------------------------------------*

*&---------------------------------------------------------------------*

*&  Include           ZEDR12_ZDOCKING_CONTAINER_F01
...
*CL_ALV_EVENT TOOLBAR_SET -> MT_TOOLBAR##
...
      IF LS_MODI-VALUE IS INITIAL. "FIELDNAME# ## VALUE# ##
...
      MODIFY GT_STUDENT FROM GS_STUDENT INDEX LS_MODI-ROW_ID. "ITAB# ### ## ####.
