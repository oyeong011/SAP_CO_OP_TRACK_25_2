...
REPORT ZEDR04_PRACTICE007 MESSAGE-ID ZMED04.
...
DATA : GT_ZEDT04_105 TYPE TABLE OF ZEDT04_105.  " ##. 105# ### ## ### ##
...
    INTO CORRESPONDING FIELDS OF TABLE GT_ZEDT04_105
...
  CONCATENATE 'ZMON' P_ZMONTH INTO LV_ZMON.



  FIELD-SYMBOLS <FS_GS_ZEDT04_105> TYPE ZEDT04_105.        " ### ###

  READ TABLE GT_ZEDT04_105 WITH KEY ZPERNR = GS_SAL-ZPERNR

                                    ZYEAR  = P_ZYEAR

                           ASSIGNING <FS_GS_ZEDT04_105>.



  FIELD-SYMBOLS <FS_MON> TYPE ANY.                  " MONXX ## ###

  ASSIGN COMPONENT LV_ZMON OF STRUCTURE <FS_GS_ZEDT04_105> TO <FS_MON>.
...
  <FS_GS_ZEDT04_105>-AENAME = SY-UNAME.

  <FS_GS_ZEDT04_105>-AEDATE = SY-DATUM.

  <FS_GS_ZEDT04_105>-AEZEIT = SY-UZEIT.



  UPDATE ZEDT04_105 FROM <FS_GS_ZEDT04_105>.
