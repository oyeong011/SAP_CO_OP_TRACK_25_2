...
REPORT ZEDR20_PRACTICE006 MESSAGE-ID ZMED20.
...
DATA: GT_ZMON LIKE TABLE OF GS_ZMON.
...
      FOR ALL ENTRIES IN GT_ZMON    " ### ### GT_ZMON# #### # ###

      WHERE A~ZPERNR = GT_ZMON-ZPERNR   " ###, ### ## ##### + ## 0## #### ##
...
    READ TABLE GT_ZMON WITH TABLE KEY ZPERNR = GS_ZPACCOUNT_DATA-ZPERNR

    INTO GS_ZMON.

    GS_ZPACCOUNT_ALV-ZMON = GS_ZMON-ZMON.
...
    PERFORM CALL_ZPINFO_ALV.

  ELSEIF P_R3 = 'X'.    " ####

    PERFORM ZPACCOUNT_FIELD_CATALOG.

    PERFORM CALL_ZPACCOUNT_ALV.
...
      T_OUTTAB = GT_ZPINFO_ALV.

ENDFORM.

FORM CALL_ZPACCOUNT_ALV.    " #### ALV ##
...
        GS_ZEDT20_105-ZMON01 = GV_SALARY.

      WHEN '02'.

        GS_ZEDT20_105-ZMON02 = GV_SALARY.

      WHEN '03'.

        GS_ZEDT20_105-ZMON03 = GV_SALARY.

      WHEN '04'.

        GS_ZEDT20_105-ZMON04 = GV_SALARY.

      WHEN '05'.

        GS_ZEDT20_105-ZMON05 = GV_SALARY.

      WHEN '06'.

        GS_ZEDT20_105-ZMON06 = GV_SALARY.

      WHEN '07'.

        GS_ZEDT20_105-ZMON07 = GV_SALARY.

      WHEN '08'.

        GS_ZEDT20_105-ZMON08 = GV_SALARY.

      WHEN '09'.

        GS_ZEDT20_105-ZMON09 = GV_SALARY.

      WHEN '10'.

        GS_ZEDT20_105-ZMON10 = GV_SALARY.

      WHEN '11'.

        GS_ZEDT20_105-ZMON11 = GV_SALARY.

      WHEN '12'.

        GS_ZEDT20_105-ZMON12 = GV_SALARY.
...
          INTO CORRESPONDING FIELDS OF TABLE GT_ZMON

          WHERE ZYEAR = P_YEAR

          " ### 0### ##### ##.

          AND ( ZMON01 NE 0 AND ZMON01 IS NOT NULL )
...
          AND ( ZMON02 NE 0 AND ZMON02 IS NOT NULL )
...
          AND ( ZMON03 NE 0 AND ZMON03 IS NOT NULL )
...
          AND ( ZMON04 NE 0 AND ZMON04 IS NOT NULL )
...
          AND ( ZMON05 NE 0 AND ZMON05 IS NOT NULL )
...
          AND ( ZMON06 NE 0 AND ZMON06 IS NOT NULL )
...
          AND ( ZMON07 NE 0 AND ZMON07 IS NOT NULL )
...
          AND ( ZMON08 NE 0 AND ZMON08 IS NOT NULL )
...
          AND ( ZMON09 NE 0 AND ZMON09 IS NOT NULL )
...
          AND ( ZMON10 NE 0 AND ZMON10 IS NOT NULL )
...
          AND ( ZMON11 NE 0 AND ZMON11 IS NOT NULL )
...
          AND ( ZMON12 NE 0 AND ZMON12 IS NOT NULL )
