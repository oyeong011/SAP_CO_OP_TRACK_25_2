...
*DATA : L_ZMNAME LIKE ZEDT19_002-ZMNAME.

*

*IF P_ZEDT19_0001 IS NOT INITIAL.

*  SELECT SINGLE ZMNAME FROM ZEDT19_002 INTO L_ZMNAME

*    WHERE ZCODE = P_ZEDT19_0001-ZCODE

*    AND ZPERNR = P_ZEDT19_0001-ZPERNR.
...
IF T_ZEDT19_0001[] IS NOT INITIAL.
