...
REPORT ZEDR19_038 LINE-SIZE 200 LINE-COUNT 65(3) NO STANDARD PAGE HEADING.
...
  CONCATENATE lv_y lv_m lv_d INTO p_text SEPARATED BY '.'.
...
        PERFORM FMT_DATE_10 USING GS_ZUMUN-ZJDATE CHANGING GS_0100-ZDATE.
...
      ,GS_0200-ZVOLUM,'|',GS_0200-VRKME,'|',LV_AMT2,'|',GS_0200-ZDFLAG_NAME,'|'
