...
REPORT ZEDR00_PRACTICE007 MESSAGE-ID ZMED00.



TABLES : ZEDT00_102, ZEDT00_103, ZEDT00_104, ZEDT00_105, ZEDT00_106.



CONSTANTS : C_X TYPE CHAR1 VALUE 'X'.

RANGES : R_FLAG FOR ZEDT00_102-ZQFLAG.
...
  ZDEPRANK LIKE ZEDT00_102-ZDEPRANK, "##
...
DATA : GT_ZEDT00_105 TYPE TABLE OF ZEDT00_105.
...
 SELECT-OPTIONS : S_ZPERNR FOR ZEDT00_102-ZPERNR.

 SELECT-OPTIONS : S_DATE FOR ZEDT00_102-DATBI NO-EXTENSION MODIF ID M1.

 PARAMETERS : P_YEAR LIKE ZEDT00_105-ZYEAR DEFAULT SY-DATUM+0(4) MODIF ID M2.

 PARAMETERS : P_MON(2) DEFAULT SY-DATUM+4(2) MODIF ID M2 .

 SELECT-OPTIONS : S_ZDEP FOR ZEDT00_102-ZDEPCODE NO INTERVALS NO-EXTENSION MODIF ID M1.
...
        IF GT_ZEDT00_105[] IS NOT INITIAL.

          MODIFY ZEDT00_105 FROM TABLE GT_ZEDT00_105.
...
    S_DATE-HIGH = SY-DATUM(6) && '01'. "&&## ## ## (=CONCATENATE)
...
  CONCATENATE P_YEAR P_MON '01' INTO LV_DATE.
...
    FROM ZEDT00_102 AS A  INNER JOIN ZEDT00_104 AS B
...
    INTO CORRESPONDING FIELDS OF TABLE GT_ZEDT00_105
...
  CONCATENATE P_YEAR P_MON INTO LV_DATE2.
...
    INNER JOIN ZEDT00_104 AS C

    ON A~ZPERNR = C~ZPERNR

    INNER JOIN ZEDT00_106 AS D
...
    FOR ALL ENTRIES IN GT_ASSESS

    WHERE ZPERNR = GT_ASSESS-ZPERNR
...
  FIELD-SYMBOLS: <FS_ZEDT00_105> TYPE ZEDT00_105.



  READ TABLE GT_ZEDT00_105 WITH KEY ZPERNR = P_ZPERNR

                                    ZYEAR = GV_YEAR ASSIGNING <FS_ZEDT00_105>.



  IF SY-SUBRC = 0.

    CONCATENATE 'ZMON' PV_MON INTO FMON.

    ASSIGN COMPONENT FMON OF STRUCTURE <FS_ZEDT00_105> TO FIELD-SYMBOL(<FS>).
...
*      SELECT SINGLE ZMON01 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON02 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON03 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON04 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON05 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON06 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON07 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON08 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON09 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON10 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON11 FROM ZEDT00_105 INTO P_ZMON
...
*      SELECT SINGLE ZMON12 FROM ZEDT00_105 INTO P_ZMON
...
                                    ZYEAR = PV_YEAR ASSIGNING <FS_ZEDT00_105>.
...
*      UPDATE ZEDT00_105 SET ZMON01 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON02 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON03 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON04 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON05 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON06 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON07 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON08 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON09 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON10 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON11 = P_ZPAY
...
*      UPDATE ZEDT00_105 SET ZMON12 = P_ZPAY
