...
*&  Include           ZSPLITTER_CONTAINER022_F01
...
  CLEAR : GS_FIELDCAT1, GT_FIELDCAT1.

  GS_FIELDCAT1-COL_POS = 1. "## ##

  GS_FIELDCAT1-FIELDNAME = 'ZCODE'. "#### ITAB### #### #

  GS_FIELDCAT1-COLTEXT = '####'. "##TEXT
...
  GS_FIELDCAT1-FIELDNAME = 'ZGENDER'.
...
  GS_FIELDCAT2-FIELDNAME = 'ZCODE'. "#### ITAB### #### #

  GS_FIELDCAT2-COLTEXT = '####'. "##TEXT
...
  GS_FIELDCAT2-FIELDNAME = 'ZGENDER'.
