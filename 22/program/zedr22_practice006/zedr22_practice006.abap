...
REPORT ZEDR_PRACTICE006 MESSAGE-ID ZMED22_1.
...
    GS_SALARY-ZPAY = GS_SALARY-ZSALARY / 12."## A##, ###
...
      SELECT SINGLE ZMON01 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON02 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON03 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON04 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON05 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON06 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON07 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON08 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON09 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON10 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON11 FROM ZEDT22_105 INTO P_ZMONTH
...
      SELECT SINGLE ZMON12 FROM ZEDT22_105 INTO P_ZMONTH
...
      UPDATE ZEDT22_105 SET ZMON01 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON02 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON03 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON04 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON05 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON06 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON07 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON08 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON09 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON10 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON11 = P_ZPAY
...
      UPDATE ZEDT22_105 SET ZMON12 = P_ZPAY
