...
*       END OF TY_ZEDT10_102.

*

*TYPES: BEGIN OF TY_ZEDT10_103,
...
*       END OF TY_ZEDT10_103.

*

*TYPES: BEGIN OF TY_ZEDT10_104,

*         ZPERNR   TYPE C LENGTH 10,  " ####

*         ZDEPCODE TYPE ZDEPCODE10,   " ####

*         ZYEAR    TYPE N LENGTH 4,   " ##
...
*       END OF TY_ZEDT10_104.

*

*TYPES: BEGIN OF TY_ZEDT10_105,

*         ZPERNR TYPE C LENGTH 10,  " ####

*         ZYEAR  TYPE N LENGTH 4,   " ##

*         ZMON01 TYPE P LENGTH 7 DECIMALS 2, " 1###

*         ZMON02 TYPE P LENGTH 7 DECIMALS 2, " 2###

*         ZMON03 TYPE P LENGTH 7 DECIMALS 2, " 3###

*         ZMON04 TYPE P LENGTH 7 DECIMALS 2, " 4###

*         ZMON05 TYPE P LENGTH 7 DECIMALS 2, " 5###

*         ZMON06 TYPE P LENGTH 7 DECIMALS 2, " 6###

*         ZMON07 TYPE P LENGTH 7 DECIMALS 2, " 7###

*         ZMON08 TYPE P LENGTH 7 DECIMALS 2, " 8###

*         ZMON09 TYPE P LENGTH 7 DECIMALS 2, " 9###

*         ZMON10 TYPE P LENGTH 7 DECIMALS 2, " 10###

*         ZMON11 TYPE P LENGTH 7 DECIMALS 2, " 11###

*         ZMON12 TYPE P LENGTH 7 DECIMALS 2, " 12###

*       END OF TY_ZEDT10_105.

*

*TYPES: BEGIN OF TY_ZEDT10_106,
...
*         ZSALARY   TYPE P LENGTH 7 DECIMALS 2, " ####

*         ZBANKCODE TYPE ZBANKCODE10,           " ####

*         ZACCOUNT  TYPE C LENGTH 20,           " ####

*       END OF TY_ZEDT10_106.
...
*        T2~ZPERNR, T3~ZPNAME, T2~ZDEPCODE, T2~ZDEPRANK,

*        T2~ZEDATE, T2~ZQFLAG, T6~ZSALARY, T4~ZRANK, T5~ZWAERS,
...
      DATA: LS_T5 LIKE GS_STAFF_RATING,

            LT_T5 LIKE TABLE OF LS_T5.

      " 105# #### ### ####

      SELECT ZPERNR ZMON01 ZMON02 ZMON03 ZMON04 ZMON05 ZMON06 ZMON07 ZMON08 ZMON09 ZMON10 ZMON11 ZMON12

        FROM ZEDT10_105

        INTO CORRESPONDING FIELDS OF TABLE LT_T5.



      LOOP AT LT_T5 INTO LS_T5.

        MODIFY GT_STAFF_RATING FROM LS_T5

          TRANSPORTING ZMON01 ZMON02 ZMON03 ZMON04 ZMON05 ZMON06 ZMON07 ZMON08 ZMON09 ZMON10 ZMON11 ZMON12

          WHERE ZPERNR = LS_T5-ZPERNR.

      ENDLOOP.



      DATA: LS_T3 LIKE GS_STAFF_RATING,

            LT_T3 LIKE TABLE OF LS_T3.



      " 103# #### ### ####

      SELECT ZPERNR ZPNAME

        FROM ZEDT10_103

        INTO CORRESPONDING FIELDS OF TABLE LT_T3.



      LOOP AT LT_T3 INTO LS_T3.

        MODIFY GT_STAFF_RATING FROM LS_T3

          TRANSPORTING ZPNAME

          WHERE ZPERNR = LS_T3-ZPERNR.
...
  DATA: LV_ERROR_FLAG TYPE C VALUE '',

        LV_QUIT_MONTH TYPE MONAT,

        LV_PAY_VALUE  TYPE CURR13_2.



  LOOP AT GT_STAFF_PAYMENT INTO GS_STAFF_PAYMENT.
...
    CHECK GS_STAFF_PAYMENT-ZRANK IS NOT INITIAL.
...
    IF GS_STAFF_PAYMENT-ZQFLAG = 'X'. " ###

      LV_QUIT_MONTH = GS_STAFF_PAYMENT-ZQDATE+4(2). " YYYYMMDD## MM ##



      IF P_MONTH > LV_QUIT_MONTH. " ### ###
...
    ASSIGN COMPONENT GV_MON_COL OF STRUCTURE GS_STAFF_PAYMENT
...
      <FS_PAY_COL> = GS_STAFF_PAYMENT-ZSALARY / 12.



      " A#### 5## ## (##: 100#### 500)

      IF GS_STAFF_PAYMENT-ZRANK = 'A'.
...
    MODIFY GT_STAFF_PAYMENT FROM GS_STAFF_PAYMENT.
...
  DATA: LV_PAY_VALUE TYPE CURR13_2,      " ### ##

        LV_ZPERNR LIKE GS_STAFF_PAYMENT-ZPERNR,
...
  LV_ZYEAR = SY-DATUM+0(4). " # ##: SY-DATUM(4) # SY-DATUM+0(4)
...
  FIELD-SYMBOLS: <MON_PAYMENT> TYPE ANY.



  LOOP AT P_GT_STAFF_PAYMENT INTO GS_STAFF_PAYMENT.
...
    IF <MON_PAYMENT> IS NOT ASSIGNED.
...
    LV_PAY_VALUE = <MON_PAYMENT>.

    LV_ZPERNR = GS_STAFF_PAYMENT-ZPERNR.
...
          SET ZMON01 = LV_PAY_VALUE

          WHERE ZPERNR = LV_ZPERNR
