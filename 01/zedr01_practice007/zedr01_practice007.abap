...
REPORT ZEDR01_PRACTICE007 MESSAGE-ID ZMED01.
...
          CONCATENATE 'GS_PAY_INFO-ZMON0' ZINDEX INTO ZMON.

          ASSIGN (ZMON) TO <FS1>.

          GS_PAY_INFO-ZPAY_MONTH = <FS1>.

         ELSE.

          CONCATENATE 'GS_PAY_INFO-ZMON' ZINDEX INTO ZMON.
...
          CONCATENATE 'GS_PAY-ZMON0' ZINDEX INTO ZMON.

          ASSIGN (ZMON) TO <FS1>.

          PERFORM CHECK_UPDATE USING <FS1> LV_MONTH_PAY.

          <FS1> = LV_MONTH_PAY.

        ELSE.

          CONCATENATE 'GS_PAY-ZMON' ZINDEX INTO ZMON.
