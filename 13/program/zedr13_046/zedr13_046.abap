...
*INSERT INTO ZEDT13_001 VALUES GS_STUDENT.
...
*INSERT ZEDT13_001 FROM TABLE GT_STUDENT. "## ## #### ## ##"

*INSERT ZEDT13_001 FROM TABLE GT_STUDENT ACCEPTING DUPLICATE KEYS. "## ## #### ## ##"
...
*UPDATE ZEDT13_001 FROM TABLE GT_STUDENT.

*UPDATE ZEDT13_001 SET ZENAME = 'JUNG'
...
*DELETE ZEDT13_001 FROM GS_STUDENT.



*DELETE FROM ZEDT13_001 WHERE ZTEL = '01000002222'.
...
*DELETE ZEDT13_001 FROM TABLE GT_STUDENT.
...
*MODIFY ZEDT13_001 FROM GS_STUDENT.
